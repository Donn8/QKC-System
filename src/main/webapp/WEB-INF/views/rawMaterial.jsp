...
<title>Raw Material Maintenance</title>
</head>
<body>
	...
	<div class="container">
		<div class="row">
			<div id="rawMaterialDiv"></div>
		</div>
		<br>
	</div>
	<jsp:include page="rawMaterialForm.jsp"/>
</body>
...
<script>
	$(document).ready(function(){
		...
		function loadDispatchTypes(){
			$.ajax({
				url: contextPath + "rawMaterial/list",
				method: "GET",
				success: function(result){
					$("#rawMaterialDiv").html(result);
					$("#rawMaterialTbl").dataTable();
				}
			});
		}
